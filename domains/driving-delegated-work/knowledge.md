...
else needs a human"; "waiting on you", never "waiting on a decision-maker". A
quiet project is good news and is said that way, in one line. Accuracy still
comes first, and a caveat that changes a decision is never softened away.
